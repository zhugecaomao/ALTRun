...
class I18n {
    ...
    static _Build() {
        ...
        s["Help.History.Key"]          := ["↑ in an empty box", "空搜索框里按 ↑"]
        s["Help.History.Text"]         := ["recent searches", "最近的搜索"]
        ...
        s["Prefs.HistorySize.Desc"]    := ["Press ↑ in the empty search box to bring back recent searches.", "空搜索框里按 ↑ 调出最近的搜索"]
        ; Appearance
