...
; Tools' own settings (see "PTTools" below, owned by Src\UI\PTToolsWindow.ahk /
; PTToolsWindow). Anyone still on a pre-JSON ALTRun.ini gets migrated
; automatically the next time they start ALTRun - see Src\Core\IniMigration.ahk
...
Class AppData {
    ...
    static DefaultCommandText() {
        ...
        (
            ...
            Func | ClipToTraditional | Clipboard: Simplified to Traditional Chinese=66
            Func | ClipToSimplified | Clipboard: Traditional to Simplified Chinese=66
            Func | Baidu | Search Clipboard or Input by Baidu=66
            Func | Taobao | Search Clipboard or Input by Taobao=66
            Func | JD | Search Clipboard or Input by JD.com=66
            Func | ShowIP | Show local IP address(es)=66
            Func | UrlEncode | Clipboard: URL-encode=66
            Func | Logoff | Log off Windows=66
            Func | ShutdownMachine | Shut down the computer=66
            Func | RestartMachine | Restart the computer=66
            Func | HibernateMachine | Hibernate the computer=66
            Func | IncreaseVolume | Increase volume=66
            Func | DecreaseVolume | Decrease volume=66
            Func | ListProcess | List running processes (tasklist)=66
            Func | ListService | List running services (net start)=66
